...
const EditResourceForm = ({ open, onOpenChange, onSaveResource, resource }: EditResourceFormProps) => {
  ...
  // Initialize form values and specifications when resource changes
  useEffect(() => {
    if (resource) {
      form.reset({
        title: resource.title || "",
  ...
  const handleSubmit = async (values: ResourceFormValues) => {
    if (!resource?.id) {
      toast({
        title: "Error",
        description: "Resource ID not found. Please try again.",
        variant: "destructive"
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Your resource has been updated in the marketplace."
      });
      ...
      toast({
        ...
        description: error.message || "There was a problem updating your resource. Please try again.",
        variant: "destructive"
      });
    } finally {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the details of your existing resource.
          </DialogDescription>
        </DialogHeader>
